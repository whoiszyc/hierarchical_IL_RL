...
ACTIONS = ["movenorth 1", "movesouth 1", "movewest 1", "moveeast 1"]  # ACTIONS is the the movements to the neighbouring blocks
MACRO_ACTIONS = ['N', 'S', 'W', 'E', 'Stay']  # ACTIONS is the the movements to the neighbouring rooms (or stay in the current rooms)
OUTPUT_MACRO_DIM = 5
...
class Agent(Visualizable):
	...
	def get_expert_policy(self, agent_host):
		...
		self.policy = best_policy(maze, value) #TODO: different from flat Algo. policy data is also used
		self.expert= {}
	...
	def get_expert_trajectory(self, agent_host, starting_loc, goal_loc):
		...
		"""
		This function generates a flat expert trajectory and parses it into a hierarchical structure
		"""
		# TODO: solve MDP using dynamic programming
		self.get_expert_policy(agent_host)

		# TODO: add data into "sa_trajectory"
		# TODO: "sa_trajectory" is the flat comprehensive trajectory generated by the expert
		self.sa_trajectory = []
		...
		# TODO: add data into "room_trajectory"
		# TODO: "room_trajectory" is all room coordinates that the agent passes
		...
		# TODO: add data into "change_point"
		# TODO: "change_point" is the step indices that indicate the room shift
		change_point = []
		...
		# TODO: generate "room_shift" and "option"
		# TODO: add "option" into "expert_macro_feedback"
		# TODO: "expert_macro_feedback" instructs the agent to move to the best room
		...
		# TODO: add "sa_trajectory" into "expert_micro_feedback"
	...
	def run_train(self, agent_host):
		...
		#TODO: "get_expert_trajectory" mainly generates "expert_micro_feedback" and "expert_macro_feedback"
		...
		self.expert_macro_a = np.zeros((1, len(MACRO_ACTIONS)))  # one-hot encoding
		self.expert_macro_a[0, expert_macro_a] = 1.		# one-hot encoding
		...
		while (not self.terminate) and (not agent_host.done) and self._step < HORIZON:
			...
			self.expert_a = np.zeros((1, len(ACTIONS)))  #TODO: one-hot encoding
			self.expert_a[0, expert_a] = 1.  #TODO: one-hot encoding

			
			agent_loc = agent_host.agent_loc

			self._a = expert_a  #TODO: exerpt action
			self._tau = expert_t   #TODO: this value determines the termination condition
